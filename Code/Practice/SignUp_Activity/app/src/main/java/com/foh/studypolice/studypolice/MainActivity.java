package com.foh.studypolice.studypolice;
...
import com.foh.studypolice.JoinedClassActivity;
import com.foh.studypolice.PostFaceActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
        ...
        Ion.with(getApplicationContext())
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        if (e != null) {
                            Toast.makeText(com.foh.studypolice.MainActivity.this, "Error " + e, Toast.LENGTH_LONG).show();
                        } else {
    ...
    */
    private void userNotAuthenticated(){
        Intent intent = new Intent(com.foh.studypolice.MainActivity.this, SignInActivity.class);
    ...
    private void logout(){
        ...
        Ion.with(getApplicationContext())
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        if(e != null){
                            Toast.makeText(com.foh.studypolice.MainActivity.this, "Not successful, try again", Toast.LENGTH_LONG).show();
                        } else {
                            setLogOutData();
                        }
                    }
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        if (e != null) {
                            ...
                            Toast.makeText(com.foh.studypolice.MainActivity.this, "Class successfully created!", Toast.LENGTH_LONG).show();
                            mDialog.dismiss();
                            getCreatedClassInfo();
                        }
                    }
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        if (e != null) {
                            ...
                            Toast.makeText(com.foh.studypolice.MainActivity.this, "Joined class successfully!", Toast.LENGTH_LONG).show();
                            mDialog.dismiss();
                            getJoinedClassInfo();
                        }
                    }
